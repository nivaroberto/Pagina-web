        ...
        <main>
            <section id="banner">
                ...
                <div class="contenedor">
                    ...
                    <p></p>
                    <a href="http://localhost:8080/Pagina_web/Login.jsp">Conviertete en uno más de nosotros</a>
                </div>
            </section>
            ...
            <section id="blog">
                ...
                <div class="contenedor">
                    <article>
                       <a href="http://localhost:8080/Pagina_web/Noticia1.jsp"> <img src="https://cdni.rt.com/actualidad/public_images/2017.10/article/59f32c0408f3d9ce208b4567.jpg"></a>
                       <a href="http://localhost:8080/Pagina_web/Noticia1.jsp"> <h4>Liberarán archivos clasificados <br>de John F. Kennedy </h4></a>
                    </article>
                    <article>
                        <a href="http://localhost:8080/Pagina_web/Noticia2.jsp"><img src="http://fernandafamiliar.soy/wp-content/uploads/2017/11/thor-ragnarok-1-696x420.jpg"></a>
                        <a href="http://localhost:8080/Pagina_web/Noticia2.jsp"><h4>Toño Sempere reseña <br> Thor: Ragnarok</h4></a>
                    </article>
                    <article>
                        <a href="http://localhost:8080/Pagina_web/Noticia3.jsp"><img src="https://ichef.bbci.co.uk/news/660/cpsprodpb/20F5/production/_87673480_87673479.jpg"></a>
                        <a href="http://localhost:8080/Pagina_web/Noticia3.jsp"><h4>¿Podrían los hackers dejarnos en <br>la edad de piedra?</h4></a>
                    </article>
                </div>
            </section>
            <section id="info">
